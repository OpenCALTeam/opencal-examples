...
{
    //initializing substates to 0
	calInitSubstateNext2Dr(sciddicaT, Q.f[0], 0);
	calInitSubstateNext2Dr(sciddicaT, Q.f[1], 0);
	calInitSubstateNext2Dr(sciddicaT, Q.f[2], 0);
	calInitSubstateNext2Dr(sciddicaT, Q.f[3], 0);
}
